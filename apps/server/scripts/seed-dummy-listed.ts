...
const qoo10Listed = await call<{ id: string }>('POST', `/api/master-products/${master.id}/list`, {
...
const shopifyListed = await call<{ id: string }>('POST', `/api/master-products/${master.id}/list`, {
