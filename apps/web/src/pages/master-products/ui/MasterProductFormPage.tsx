        ...
        <Section title="기본 정보">
          <Stack gap={4}>
            ...
            <Box>
              ...
              <HelperText>
                {originType === "domestic" &&
                  "국내 제조 상품. 지역 입력 시 더 상세한 정보 제공 가능."}
                {originType === "overseas" &&
                  "해외 제조 국가를 입력하세요 (한글 또는 영문)."}
                {originType === "other" &&
                  "국가 구분이 어렵거나 복합 원산지인 경우 자유 입력하세요."}
              </HelperText>
            </Box>
          ...
          >
            ...
            {draftVariants.length > 0 && (
              <Box px={5} pb={5}>
                <Text fontSize="sm" fontWeight="medium" mb={3} color="gray.700">
                  옵션 목록 ({draftVariants.length}개) — SKU와 가격/재고를
                  입력하세요
                </Text>
                <Box
                  borderWidth="1px"
                        ...
                        <Table.Row key={row._key} _hover={{ bg: "gray.50" }}>
                          ...
                          <Table.Cell>
                            <Input
                              ...
                              value={row.sku}
                              onChange={(e) =>
                                updateDraftRow(row._key, "sku", e.target.value)
                              }
                              placeholder="SKU"
                            />
                          </Table.Cell>
                ...
                <Text fontSize="xs" color="gray.400" mt={2}>
                  * SKU 미입력 행은 등록 시 건너뜁니다. 등록 버튼 클릭 시 마스터
                  상품과 함께 저장됩니다.
                </Text>
              </Box>
            )}
            ...
            {draftVariants.length === 0 && optionAxes.length === 0 && (
              <Box px={5} pb={5}>
                ...
                <Text fontSize="xs" color="gray.400" mt={2}>
                  * 위에서 옵션을 추가하면 옵션 조합별 SKU/재고 입력으로
                  전환됩니다.
                </Text>
              </Box>
            )}
                              ...
                              if (field.key === "qoo10.ItemQty") {
                                return (
                                  <Box key={field.key}>
                                    ...
                                    />
                                    <HelperText>
                                      변형(Variants) 재고 합계에서 자동
                                      계산됩니다. (현재: {totalVariantStock}개)
                                    </HelperText>
                                  </Box>
                                );
                              }
                              ...
                              if (field.key === "qoo10.ItemPrice") {
                                return (
                                  <Box key={field.key}>
                                    ...
                                    />
                                    <HelperText>
                                      첫 번째 변형(Variant) 가격에서 자동
                                      계산됩니다.
                                      {firstVariantPrice !== "" &&
                                        ` (현재: ¥${firstVariantPrice})`}
                                    </HelperText>
                                  </Box>
                                );
                              }
