              ...
              {channelDetailError && (
                ...
                >
                  <Text fontSize="xs" color="red.600">
                    채널 상품 옵션을 불러올 수 없습니다. Qoo10 API에서 해당
                    상품을 찾지 못했습니다. (ItemCode:{" "}
                    {channelProduct.channelItemId})
                  </Text>
                </Box>
              )}
          ...
          {step === "result" && resultData && (
            <Stack gap={3} align="center" py={4}>
              ...
              <Text fontSize="sm" color="gray.600" textAlign="center">
                &ldquo;{channelProduct.title}&rdquo; ↔ &ldquo;
                {masterDetail?.title}&rdquo; 연결됨
              </Text>
              <Stack gap={1} w="100%">
                <Text fontSize="sm">
