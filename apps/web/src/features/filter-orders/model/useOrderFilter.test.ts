...
const MOCK_ORDERS: Order[] = [
  makeOrder({
    ...
    status: '신규',
    buyerName: '홍길동',
    items: [{ id: 'i1', productName: 'Shopify 상품 A', quantity: 1, unitPrice: 50000, totalPrice: 50000 }],
  }),
  makeOrder({
    id: 'order-2',
    ...
    status: '배송중',
    buyerName: '김철수',
    items: [{ id: 'i2', productName: 'Qoo10 상품 B', quantity: 2, unitPrice: 30000, totalPrice: 60000 }],
    currency: 'KRW',
  }),
  makeOrder({
    id: 'order-3',
    ...
    status: '취소',
    buyerName: '이영희',
    items: [{ id: 'i3', productName: 'Shopify 상품 C', quantity: 1, unitPrice: 20000, totalPrice: 20000 }],
  }),
];
...
describe('useOrderFilter', () => {
  ...
  it('채널 필터 적용 시 해당 채널 주문만 반환된다', () => {
    ...
    expect(result.current.filteredOrders.every((o) => o.channelId === 'shopify')).toBe(true);
  });
