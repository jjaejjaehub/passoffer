...
export interface DispatchDelayModalProps {
  open: boolean;
  onClose: () => void;
  orderCount: number;
  onConfirm: (input: {
...
export function DispatchDelayModal({
  open,
  onClose,
  orderCount,
  onConfirm,
}: DispatchDelayModalProps): React.JSX.Element | null {
  ...
  const submit = async (): Promise<void> => {
    ...
    try {
      ...
      const message =
        err instanceof Error ? err.message : '배송지연 처리에 실패했습니다.';
          ...
          <Flex align="center" gap={2}>
            ...
            <Box>
              ...
              <Text fontSize="xs" color="gray.500" mt={0.5}>
                선택된 {orderCount.toLocaleString()}건 주문의 발송예정일을 변경합니다
              </Text>
            </Box>
          </Flex>
          <button
          ...
          <VStack gap={4} align="stretch">
            ...
            >
              <Text fontSize="xs" color="orange.800">
                ...
                <br />
                결제완료(10) 단계 주문은 신규주문(20)으로 자동 전환됩니다.
                <br />
                Shopify 주문은 발송예정일 push API가 없어 DB만 갱신됩니다.
              </Text>
            </Box>
            ...
            <HStack gap={2} justify="flex-end">
              ...
              >
                {orderCount.toLocaleString()}건 변경
              </Button>
            </HStack>
          </VStack>
        </Box>
