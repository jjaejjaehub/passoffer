# UpdateMoveGoods — MOVE 상품 편집

## 메타

- **메서드명**: `UpdateMoveGoods`
- **서비스**: `ItemsBasic` (상품 정보 등록 & 수정)
- **클래스**: `GoodsBasicBiz` (`GMKT.INC.Front.QAPIBiz.Goods.GoodsBasicBiz`)
- **m_no / c_no**: 15758 / 10004
- **그룹**: 상품 관리
- **원본 크롤링 파일**: `_raw/15758_info.json`, `_raw/15758_params.json`
...
| `RetailPrice` | Int32 | N | 1~999999999 | 参考価格 最大9桁(半角数字) | 15000 |
...
| `OptionMainimage` | String | Y | MAX 200 | 옵션메인이미지 [주의] [옵션명]에 입력한 옵션명별로 모두 설정해야 합니다.  옵션명별 1개  옵션명1\|\|*이미지URL$$ 옵션명2\|\|*이미지URL  예) 블랙\|\|*https://dp.image-qoo10.jp/GMKT.IMG/loading_2017/qoo10_loading.v_20170420.png | Black\|\|*https://dp.image-qoo10.jp/GMKT.IMG/loading_2017/qoo10_loading.v_20170420.png |
| `OptionSubimage` | String | N | MAX 10 an option | 옵션별 서브이미지 옵션명1\|\|*이미지URL 옵션명2\|\|*이미지URL1\|\|*이미지URL2$$\|\|*이미지URL3$$  옵션명별 최대 10개  예) 블랙\|\|*https://dp.image-qoo10.jp/GMKT.IMG/loading_2017/qoo10_loading.v_20170420.png$$ 레드\|\|*https://dp.image-qoo10.jp/GMKT.IMG/loading_2017/qoo10_loading.v_20170420.png$$ | Black\|\|*https://dp.image-qoo10.jp/GMKT.IMG/loading_2017/qoo10_loading.v_20170420.png$$ Red\|\|*https://dp.image-qoo10.jp/GMKT.IMG/loading_2017/qoo10_loading.v_20170420.png$$ |
...
| `TpoNumber` | String | Y | Min code 1 to 2 | TPO [안내] 여성복 카테고리에 한해 필수로 입력해 주세요. TPO코드 입력  최소 1개, 최대 2개 ($$로 구분) <br><br> TPO코드 확인<br> https://qsmupload.qoo10.jp/GMKT.INC.Gsm.Web/Product/MoveDataExcelManagement.aspx | TPO0001$$TPO0002 |
...
| `ImageOtherUrl` | String | N | MAX 10 images | 추가이미지 이미지 URL (JPG, PNG, GIF)   최대 50개 (추가 $$로 구분)  최대 10,000글자 | https://dp.image-qoo10.jp/GMKT.IMG/loading_2017/qoo10_loading.v_20170420.png$$https://dp.image-qoo10.jp/GMKT.IMG/loading_2017/qoo10_loading.v_20170420.png |
...
| `ShippingNo` | Int32 | Y | MAX 20 | 배송비 코드 (숫자) 최대6자리 | 123456 |
...
| `OriginCountryId` | String | N | 2 | [안내] [원산지]가 2:해외일 시 국가코드를 필수로 입력해 주세요.  국가코드 2글자 (영문) | CN |
| `OriginOthers` | String | N | MAX50 | [안내] [원산지]가 3:기타일 시 내용을 필수로 입력해 주세요.  최대 50글자 | OOに限りOO国から発送 |
...
| `IndustrialCodeType` | String | N | 1 | 표준산업코드 타입 JAN : JAN코드 KAN : KAN코드 ISBN : ISBN코드 UPC : UPC코드 EAN : EAN코드 HS : HS코드 | JAN |
...
| `ShippingName` | String | N | MAX 50 | 주문/배송 관리코드 : QSM 주문/배송 관리 화면에 한해 상품명에 함께 표기되는 정보이며, 상품 구분을 위해 활용하실 수 있습니다. | 123456789 |
